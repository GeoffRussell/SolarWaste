...
nyears<-100
failFun<-makeFail(40)
failWeibull5Fun<-makeWeibullFail(40,5)
failWeibull3Fun<-makeWeibullFail(40,3)
failed<-rep(0,nyears)
...
dfout %>% ggplot()+
  ...
  annotate('text',x=22,y=25,label="k=3",color="red")+
  annotate('text',x=32,y=12,label="k=5",color="orange")+
